...
Cylinder cylinder = Cylinder(1, 2, 20, 1);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Cylinder", NULL, NULL);
	if (window == NULL)
	{
	...
	glBufferData(GL_ARRAY_BUFFER, cylinder.getCoordinatesSize(), cylinder.getCoordinates(), GL_STATIC_DRAW);                     // usage
	//
	//for coordinates
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.use();
		lightingShader.setVec3("objectColor", 0.0f, 0.255f, 0.0f);
		...
		// render the cylinder
		glBindVertexArray(cylinderVAO);
		glDrawElements(GL_TRIANGLE_STRIP, cylinder.getIndexCount(), GL_UNSIGNED_INT, (void*)0);
	...
	glDeleteVertexArrays(1, &cylinderVBO);
